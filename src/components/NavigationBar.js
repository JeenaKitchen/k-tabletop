  ...
  return (
    <nav className={`navigation-bar ${isKTabletopPage ? 'compact' : ''} ${isMenuOpen ? 'menu-open' : ''}`}>
      <div className="nav-container">
        ...
        {/* Mobile Navigation - Language + Hamburger (no social buttons) */}
      ...
      {isMenuOpen && (
        <div className="mobile-menu-container">
          <div className="mobile-menu">
            ...
            {/* Social + Email row inside mobile menu */}
            <div className="mobile-menu-socials">
              ...
              <a
                href="mailto:jeena.s.kitchen@gmail.com"
                className="nav-item social-button email-button"
                title="Email"
                aria-label="Email"
              >
                <img src="/icons/social-media/email-icon.svg" alt="Email" width="22" height="22" />
              </a>
            </div>
          </div>
        </div>
